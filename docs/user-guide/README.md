# Marveen - Felhasználói kézikönyv / User Guide

Ez a kézikönyv a Marveen dashboard minden nézetét dokumentálja, magyar és angol nyelven.
This guide documents every view of the Marveen dashboard, in Hungarian and English.
...
| # | Fejezet | Leírás |
|---|---------|--------|
| 01 | [Áttekintés](hu/01-attekintes.md) | Főoldal, rendszerállapot, csapat-aktivitás |
| 02 | [Kanban](hu/02-kanban.md) | Feladatkezelő tábla - kártyák, szűrők, prioritások |
| 03 | [Jóváhagyások](hu/03-jovahagyasok.md) | Ágens-kérések kezelése |
| 04 | [Ágensek](hu/04-agensek.md) | Ágens-konfiguráció és csatornák |
...
| # | Chapter | Description |
|---|---------|-------------|
| 01 | [Overview](en/01-overview.md) | Dashboard home, system status, team activity |
| 02 | [Kanban](en/02-kanban.md) | Task board - cards, filters, priorities |
| 03 | [Approvals](en/03-approvals.md) | Agent action request management |
| 04 | [Agents](en/04-agents.md) | Agent configuration and channels |
| 05 | [Messages](en/05-messages.md) | Inter-agent message exchange |
...
> Az `[ADMIN]` jelölésű fejezetek csak rendszergazdák számára láthatók.
> Chapters marked `[ADMIN]` are visible to administrators only.
