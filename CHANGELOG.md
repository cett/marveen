...
- retire dashboard-auth-recovery.md and rbac-multi-tenant.md now that their content lives in the user guide (chapters 18 and 15); every inbound reference (README.md, web/lang/en.js+hu.js, scripts/dashboard-user.ts) repointed to the new location instead of left dangling
