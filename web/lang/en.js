...
window._i18n.en = {
  ...
  'help.not_found':           'This help chapter could not be found.',
  'help.load_error':          'Failed to load the help chapter.',
  'nav.help':                 'Help',
  'help.index.user_guide_heading':   'User guide',
  'help.index.fork_guide_heading':   'Installation and operations guide',
  'help.chapter.introduction':  'Introduction',
  'help.chapter.overview':      'Overview',
  'help.chapter.kanban':        'Kanban',
  'help.chapter.approvals':     'Approvals',
  'help.chapter.agents':        'Agents',
  'help.chapter.messages':      'Messages',
  'help.chapter.tasks':         'Tasks',
  'help.chapter.memories':      'Memories',
  'help.chapter.skills':        'Skills',
  'help.chapter.knowledge':     'Knowledge (ideas, artifacts, workspace docs)',
  'help.chapter.statistics':    'Statistics',
  'help.chapter.settings':      'Settings',
  'help.chapter.vault':         'Vault',
  'help.chapter.audit':         'Audit trail',
  'help.chapter.backups':       'Backups',
  'help.chapter.users':         'Users',
  'help.chapter.connections':   'Connections (MCP, federation, import)',
  'help.chapter.updates':       'Updates',
  'help.chapter.profile':       'Profile',
  'help.chapter.prerequisites': 'Prerequisites',
  'help.chapter.installation':  'Installation',
  'help.chapter.configuration': 'Configuration',
  'help.chapter.operations':    'Operations',
  'help.chapter.architecture':  'Architecture',
  'help.chapter.channels':      'Channels',
  'help.chapter.mcp':           'MCP',
  'help.chapter.fleet':         'Fleet',
  ...
  'nav.workspaceDocs':  'Workspace Docs',
  'nav.group.team':        'Team',
  ...
  'memories.tab.artifacts':      '📦 Artifacts',
  'memories.artifacts.kind_all': 'All types',
  'memories.artifacts.loading':  'Loading...',
  'memories.artifacts.load_error': 'Load error.',
  'memories.artifacts.empty':    'No artifacts.',
  'memories.artifacts.col.agent':   'Agent',
  'memories.artifacts.col.title':   'Title',
  'memories.artifacts.col.kind':    'Type',
  'memories.artifacts.col.date':    'Date',
  'memories.artifacts.col.actions': 'Actions',
  'memories.artifacts.btn.preview': 'Preview',
  'memories.artifacts.btn.open':    'Open',
  'memories.artifacts.btn.download':'Download',
  'artifacts.btn.rename':          'Rename',
  'artifacts.rename.placeholder':  'New title...',
  'artifacts.rename.success':      'Artifact renamed.',
  'artifacts.rename.error':        'Rename failed.',
  ...
  'settings.module.costops':     'Budgets',
  ...
  'settings.module.rendszer':          'System',
  'settings.module.csatornak':         'Channels & Security',
  'settings.module.agensek':           'Agents & Heartbeat',
  'settings.module.memoria':           'Memory & Workspace Docs',
  'settings.module.fleet-monitor':     'Fleet monitor',
  'settings.module.adatmegorzs':       'Retention & Observability',
  'settings.module.budgetek-csomagok': 'Budgets & Claude Plans',
  'settings.subgroup.agent_model': 'Agent model',
  'settings.subgroup.heartbeat':   'Heartbeat',
  'settings.subgroup.wip_limits':  'WIP limits',
  'settings.subgroup.wip_colors':  'WIP badge colors',
  'settings.subgroup.archive':     'Auto-archiving',
  'settings.subgroup.aging':       'Aging indicators',
  'settings.subgroup.display':     'Display',
  'settings.subgroup.ideabox':     'Idea Box',
  'settings.subgroup.bb_signals':  'Signals (A and B signal)',
  'settings.subgroup.bb_stale':    'Stale thresholds by tier',
  'settings.subgroup.audit_logs':  'Audit & logs',
  'settings.subgroup.token_usage': 'Token usage',
  'settings.subgroup.otel':        'OpenTelemetry export',
  'settings.subgroup.backups':     'Backups',
  'settings.costops.add_btn':    '+ Budget',
  'settings.costops.empty':      'No budgets configured.',
  'settings.costops.col.name':   'Name',
  'settings.costops.col.scope':  'Scope',
  'settings.costops.col.amount': 'Spent / limit',
  'settings.costops.col.status': 'Status',
  'settings.costops.modal.add_title':  'New budget',
  'settings.costops.modal.edit_title': 'Edit budget',
  'settings.costops.field.id':          'ID',
  'settings.costops.field.id.hint':     'Lowercase letters, digits, hyphen/underscore; immutable after creation',
  'settings.costops.field.name':        'Name',
  'settings.costops.field.scope':       'Scope',
  'settings.costops.field.scope_ref.agent':  'Agent ID',
  'settings.costops.field.scope_ref.tenant': 'Tenant ID',
  'settings.costops.field.amount':      'Monthly limit (tokens)',
  'settings.costops.field.warning_threshold': 'Warning threshold',
  'settings.costops.field.hard_threshold':    'Hard threshold',
  'settings.costops.field.block_on_hard':     'Block at hard threshold',
  'settings.costops.scope.global': 'Global',
  'settings.costops.scope.agent':  'Agent',
  'settings.costops.scope.tenant': 'Tenant',
  'settings.costops.toast.saved':   'Budget saved',
  'settings.costops.toast.deleted': 'Budget deleted',
  'settings.costops.toast.error':   'Something went wrong',
  'settings.costops.confirm_delete': 'Delete budget "{id}"?',
  ...
  'settings.claude_plans.last_known': 'last known: {pct}% (5h)',
  'settings.claude_plans.confirm_delete': 'Delete plan "{id}" from the registry?',
  'settings.claude_plans.form.id':          'Id',
  'settings.claude_plans.form.label':       'Label',
  'settings.claude_plans.form.config_dir':  'CLAUDE_CONFIG_DIR',
  'settings.claude_plans.form.type':        'Type',
  'settings.claude_plans.form.type_personal': 'Personal',
  'settings.claude_plans.form.type_team':     'Team',
  'settings.claude_plans.form.channels_allowed': 'Channels (Telegram etc.) allowed on this plan',
  ...
  'settings.desc.TOKEN_USAGE_RETENTION_DAYS':  'Retention period in days for the raw token usage log. The daily sweep aggregates rows older than this into daily/monthly rollups, then deletes them.',
  'settings.desc.TOKEN_USAGE_DAILY_RETENTION_DAYS':  'Retention period in days for daily token rollups. Rollups preserve per-agent/model daily token counts for billing and cost-audit purposes.',
  'settings.desc.TOKEN_USAGE_MONTHLY_RETENTION_DAYS':  'Retention period in days for monthly token rollups. Monthly data serves long-term trend analysis and annual audit requirements.',
  ...
  'tokenUsage.costops_budgets_title': 'Monthly token budget alert',
  'tokenUsage.costops_scope_global':  'global',
  'tokenUsage.costops_scope_agent':   'agent: {name}',
  'tokenUsage.costops_scope_tenant':  'tenant: {name}',
  'tokenUsage.costops_blocked':       'blocked',
  ...
  'agents.tenant_main_badge':		'{tenant} main agent',
  'agents.tenant_main_title':		'Main agent for the {tenant} tenant',
  ...
  'agents.tab.mcp_scope':        'MCP Scope',
  'agents.mcp_scope.mode_full':              'Full access (from security profile)',
  'agents.mcp_scope.mode_readonly':          'Read-only (list/get/search tools)',
  'agents.mcp_scope.mode_custom':            'Custom',
  'agents.mcp_scope.server_all_toggle':      'All tools enabled',
  'agents.mcp_scope.server_blocked':         'Server blocked',
  'agents.mcp_scope.dangerous_badge':        'Dangerous',
  'agents.mcp_scope.save':                   'Save scope',
  'agents.mcp_scope.save_ok':                'MCP scope saved.',
  'agents.mcp_scope.save_error':             'Error saving MCP scope.',
  'agents.mcp_scope.unsaved':                'Unsaved changes',
  'agents.mcp_scope.unknown_server_hint':    'Tool name (e.g. my_tool) -- for custom servers',
  'agents.mcp_scope.add_custom_tool':        'Add',
  'agents.mcp_scope.confirm_dangerous':      'This will allow dangerous operations (push, merge, delete). Are you sure?',
  'agents.mcp_scope.no_servers':             'No MCP servers configured for this agent (.mcp.json).',
  'agents.mcp_scope.unmanaged_hint':         'No custom scope set -- agent inherits permissions from the security profile.',
  ...
  'agents.settings.idle_flush_label': 'Idle flush',
  'agents.settings.idle_flush_enabled': 'Enabled',
  'agents.settings.idle_flush_tokens_label': 'Threshold (thousand tokens)',
  ...
  'memories.stat.import':         'Imported',
  'memories.stat.import_title':   'Memories imported from external sources',

  'import.type.local':            'Local folder',
  'import.type.gdrive':           'Google Drive',
  'import.type.sharepoint':       'SharePoint',
  'import.type.confluence':       'Confluence',
  'import.toggle.label':          'Enabled',
  'import.toggle.active':         'Active',
  'import.path.label':            'Path / folder ID',
  'import.last_run':              'Last run',
  'import.col.type':              'Type',
  'import.col.name':              'Name / Path',
  'import.col.interval':          'Interval',
  'import.col.last_sync':         'Last sync',
  'import.col.status':            'Status',
  'import.col.actions':           'Actions',
  'import.col.tenant':            'Tenant',
  'import.status.active':         'Active',
  'import.status.inactive':       'Inactive',
  'import.btn.enable':            'Enable',
  'import.btn.disable':           'Disable',
  'import.btn.sync':              'Sync now',
  'import.btn.syncing':           'Syncing...',
  'import.btn.log':               'Log',
  'import.btn.wipe_source':       'Clear content',
  'import.btn.delete':            'Delete source',
  'import.btn.add':               'Add source',
  ...
  'import.log.added':             'Added',
  'import.log.updated':           'Updated',
  'import.log.skipped':           'Skipped',
  'import.log.error':             'Error',
  'import.confirm.wipe_source':   'Delete all imported memories for this source?',
  'import.confirm.delete_source': 'Delete this source and all its imported memories?',
  'import.confirm.wipe_all':      'Delete all imported memories?',
  'import.toast.sync_queued':     'Sync queued.',
  'import.toast.source_added':    'Source added.',
  'import.toast.deleted':         'Source deleted.',
  'import.toast.wiped':           'Imported memories cleared.',
  'import.toast.all_wiped':       'All imported memories cleared.',
  'import.toast.error':           'An error occurred.',
  'import.toast.path_required':   'Path is required.',
  'import.form.type':             'Source type',
  'import.form.path':             'Path / folder ID',
  'import.form.label':            'Label (optional)',
  'import.form.interval':         'Sync interval',
  ...
  'backups.stat.retention':            'Archives kept',
  'backups.stat.retention_value':      '{n} archives',
  ...
  'backups.settings.keep_label':       'Number of backups kept (BACKUP_KEEP)',
  'backups.settings.keep_hint':        'Keeps the most recent N archives; extras beyond that are pruned on the next backup run.',
  ...
  'admin.b2b.tenant.empty':          'No tenants.',
  'admin.b2b.tenant.modal.title':    'New tenant',
  'admin.b2b.tenant.id':             'Tenant ID',
  'admin.b2b.tenant.id.hint':        'Lowercase letters, digits, hyphens; 3-63 characters',
  'admin.b2b.tenant.display_name':   'Display name',
  'admin.b2b.agent.matrix':          'Agent access',
  'admin.b2b.user.add':              '+ User',
  'admin.b2b.user.filter.all':       'All tenants',
  'admin.b2b.user.modal.title':      'New user',
  'admin.b2b.user.username':         'Username',
  'admin.b2b.user.password':         'Password (min. 12 chars)',
  'admin.b2b.user.role':             'Role',
  ...
  'admin.b2b.permission_matrix.cat.approvals':  'Approvals',
  'admin.b2b.permission_matrix.cat.federation': 'Federation',
  'admin.b2b.permission_matrix.cat.admin':      'Administration',
  'admin.b2b.perm.memories.read.label':    'View memories',
  'admin.b2b.perm.memories.read.desc':     'Read memories and recall',
  'admin.b2b.perm.memories.write.label':   'Edit memories',
  'admin.b2b.perm.memories.write.desc':    'Create, update, delete memories',
  'admin.b2b.perm.kanban.read.label':      'View tasks',
  'admin.b2b.perm.kanban.read.desc':       'Read kanban cards and projects',
  'admin.b2b.perm.kanban.write.label':     'Edit tasks',
  'admin.b2b.perm.kanban.write.desc':      'Create, move, delete cards',
  'admin.b2b.perm.agents.read.label':      'List agents',
  'admin.b2b.perm.agents.read.desc':       'View agents and their status',
  'admin.b2b.perm.messages.write.label':   'Send messages',
  'admin.b2b.perm.messages.write.desc':    'Start inter-agent messages',
  'admin.b2b.perm.blackboard.read.label':  'View fleet board',
  'admin.b2b.perm.blackboard.read.desc':   'Read agents\' current status rows',
  'admin.b2b.perm.blackboard.write.label': 'Update fleet board',
  'admin.b2b.perm.blackboard.write.desc':  'Write your own status row to the shared board',
  'admin.b2b.perm.approvals.read.label':   'View approvals',
  'admin.b2b.perm.approvals.read.desc':    'List approval requests and details',
  'admin.b2b.perm.approvals.write.label':  'Manage approvals',
  'admin.b2b.perm.approvals.write.desc':   'Approve or reject requests',
  'admin.b2b.perm.federation.read.label':  'View federation',
  'admin.b2b.perm.federation.read.desc':   'Read federated agent communication',
  'admin.b2b.perm.federation.write.label': 'Send federation',
  'admin.b2b.perm.federation.write.desc':  'Start federated messages and replies',
  'admin.b2b.perm.admin.all.label':        'Full admin access',
  'admin.b2b.perm.admin.all.desc':         'Users, tokens, tenant management -- all administrative operations',

  'admin.b2b.screen_access.title':          'Screen access',
  'admin.b2b.screen_access.subtitle':       'Which role can reach which dashboard screen',
  'admin.b2b.screen_access.shadow_note':    'RBAC currently runs in shadow mode; the table above shows the enforce state it will have once active. Screens marked (!) don\'t yet hide their nav for roles that would get a 403 -- that\'s separate, later work tied to enabling enforce mode.',
  'admin.b2b.screen_access.legend.full':    'full access',
  'admin.b2b.screen_access.legend.ro':      'nav visible, read OK, write denied server-side',
  'admin.b2b.screen_access.legend.gap':     'nav visible, but the API 403s in enforce mode (frontend gating missing)',
  'admin.b2b.screen_access.legend.none':    'not reachable (nav hidden / page guard redirects)',
  'admin.b2b.screen_access.screen.overview':      'Overview',
  'admin.b2b.screen_access.screen.kanban':        'Kanban',
  'admin.b2b.screen_access.screen.approvals':     'Approvals',
  'admin.b2b.screen_access.screen.workspaceDocs': 'Workspace docs',
  'admin.b2b.screen_access.screen.agents':        'Agents',
  'admin.b2b.screen_access.screen.memories':      'Memory',
  ...
  'admin.b2b.screen_access.screen.status':        'Status',
  'admin.b2b.screen_access.screen.updates':       'Updates',
  ...
  'profile.btn.edit':                     'Edit details',
  'profile.tenant.global':                'Global admin',
  'profile.security.title':               'Security',
  'profile.security.password.title':      'Change password',
  'profile.security.password.desc':       'The new password must be at least 12 characters long.',
  'profile.security.password.btn':        'Change password',
  'profile.security.sessions.title':      'Sessions',
  'profile.security.sessions.desc':       '{n} active session(s). Logging out applies to every device, including this browser.',
  'profile.security.sessions.btn':        'Log out everywhere',
  'profile.agents.title':                 'Available agents',
  'profile.agents.placeholder':           'The agents enabled for your tenant will appear here.',
  'profile.modal.edit.title':             'Edit details',
  'profile.modal.edit.desc':              'Your username and role can only be changed by an administrator.',
  'profile.modal.password.title':         'Change password',
  'profile.modal.password.desc':          'After saving, your other sessions stay signed in.',
  'profile.modal.password.current':       'Current password',
  'profile.modal.password.new':           'New password',
  'profile.modal.password.hint':          'At least 12 characters.',
  'profile.modal.password.confirm':       'Confirm new password',
  'profile.modal.password.mismatch':      'The two passwords do not match.',
  'profile.modal.password.too_short':     'The password must be at least 12 characters.',
  'profile.modal.sessions.title':         'Log out of all sessions',
  'profile.modal.sessions.desc':          'active session(s) will be logged out, including this browser. You will need to sign in again afterwards.',
  'profile.modal.sessions.confirm':       'Log out',
  'profile.saved':                        'Details saved',
  'profile.password_saved':               'Password updated',
  'profile.sessions_revoked':             'All sessions logged out, redirecting...',
  ...
  'admin.rbac.action.revoke':                   'Revoke',

  'admin.rbac.token.add':                       '+ Token',
  'admin.rbac.token.modal.title':               'New Token',
  'admin.rbac.token.expiry':                    'Expiry (in days, optional)',
  'admin.rbac.token.expiry_ph':                 'never expires',
  'admin.rbac.token.empty':                     'No tokens.',
  'admin.rbac.token.expires_label':             'Expires:',
  'admin.rbac.token.last_used_label':           'Last used:',
  'admin.rbac.token.revoked_badge':             'revoked',
  'admin.rbac.token.rotate':                    'Rotate',
  'admin.rbac.token.name_required':             'Name is required',
  'admin.rbac.token.created':                   'Token created',
  'admin.rbac.token.rotate_confirm':            'Rotate the "{name}" token? The old one becomes invalid immediately.',
  'admin.rbac.token.rotated':                   'Token rotated',
  'admin.rbac.token.revoke_confirm':            'Revoke the "{name}" token?',
  'admin.rbac.token.revoked_toast':             'Token revoked',
  'admin.rbac.token.reveal.title':              'Token Value',
  'admin.rbac.token.reveal.desc':               'This value is shown only now -- save it somewhere safe, it cannot be retrieved again.',
  'admin.rbac.token.reveal.copy':                'Copy',

  'admin.rbac.partner_sender.add':               '+ Partner Sender',
  'admin.rbac.partner_sender.modal.title':       'New Partner Sender',
  'admin.rbac.partner_sender.sender_id':         'Sender ID',
  'admin.rbac.partner_sender.sender_id_ph':      'e.g. acme-support-bot',
  'admin.rbac.partner_sender.sender_id_hint':    'Letters, digits, hyphens, underscores, max 63 characters; must not match a fleet agent id',
  'admin.rbac.partner_sender.empty':             'No partner senders.',
  'admin.rbac.partner_sender.disabled_badge':    'disabled',
  'admin.rbac.partner_sender.id_tenant_required':'Sender ID and tenant are required',
  'admin.rbac.partner_sender.created':           'Partner sender created',
  'admin.rbac.partner_sender.delete_confirm':    'Delete the "{senderId}" partner sender ({tenantId})?',
  'admin.rbac.partner_sender.deleted':           'Partner sender deleted',

  'admin.rbac.skill.select_placeholder':         '-- Select a skill --',
  'admin.rbac.skill.grant_add':                  '+ Grant Access',
  'admin.rbac.skill.select_hint':                'Select a skill to manage its access.',
  'admin.rbac.skill.list_load_error':            'Error loading the skill list:',
  'admin.rbac.skill.no_access':                  'This skill is not explicitly shared with any tenant.',
  'admin.rbac.skill.granted_label':              'Granted:',
  'admin.rbac.skill.tenant_required':            'Tenant is required',
  'admin.rbac.skill.granted_toast':              'Access granted',
  'admin.rbac.skill.revoke_confirm':             'Revoke the "{tenantId}" tenant\'s access to this skill?',
  'admin.rbac.skill.revoked_toast':              'Access revoked',
  'admin.rbac.skill.grant.modal_title':          'Grant Access',
  'admin.rbac.skill.grant.confirm':              'Grant',
