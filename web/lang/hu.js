...
window._i18n.hu = {
  ...
  'help.title':               'Súgó',
  'help.loading':             'Betöltés...',
  'help.not_found':           'Ez a súgó-fejezet nem található.',
  'help.load_error':          'A súgó-fejezet betöltése nem sikerült.',
  'nav.help':                 'Súgó',
  'help.index.user_guide_heading':   'Felhasználói kézikönyv',
  'help.index.fork_guide_heading':   'Telepítési és üzemeltetési kézikönyv',
  'help.chapter.introduction':  'Bevezető',
  'help.chapter.overview':      'Áttekintés',
  'help.chapter.kanban':        'Kanban',
  'help.chapter.approvals':     'Jóváhagyások',
  'help.chapter.agents':        'Ügynökök',
  'help.chapter.messages':      'Üzenetek',
  'help.chapter.tasks':         'Feladatok',
  'help.chapter.memories':      'Memória',
  'help.chapter.skills':        'Skillek',
  'help.chapter.knowledge':     'Tudástár (ötletek, artifaktek, munkadokumentumok)',
  'help.chapter.statistics':    'Statisztikák',
  'help.chapter.settings':      'Beállítások',
  'help.chapter.vault':         'Vault',
  'help.chapter.audit':         'Audit trail',
  'help.chapter.backups':       'Adatmentés',
  'help.chapter.users':         'Felhasználók',
  'help.chapter.connections':   'Kapcsolatok (MCP, föderáció, import)',
  'help.chapter.updates':       'Frissítések',
  'help.chapter.profile':       'Profil',
  'help.chapter.prerequisites': 'Előfeltételek',
  'help.chapter.installation':  'Telepítés',
  'help.chapter.configuration': 'Konfiguráció',
  'help.chapter.operations':    'Üzemeltetés',
  'help.chapter.architecture':  'Architektúra',
  'help.chapter.channels':      'Csatornák',
  'help.chapter.mcp':           'MCP',
  'help.chapter.fleet':         'Flotta',
  ...
  'nav.workspaceDocs':  'Munkadokumentumok',
  ...
  'agents.tenant_main_badge':      '{tenant} főügynök',
  'agents.tenant_main_title':      '{tenant} tenant főügynöke',
  'agents.tenant_chip':            '{tenant}',
  ...
  'agents.tab.mcp_scope':        'MCP hatáskör',
  'agents.mcp_scope.mode_full':              'Teljes hozzáférés (profil alapján)',
  'agents.mcp_scope.mode_readonly':          'Csak olvasás (list/get/search toolok)',
  'agents.mcp_scope.mode_custom':            'Egyéni',
  'agents.mcp_scope.server_all_toggle':      'Mind engedélyezve',
  'agents.mcp_scope.server_blocked':         'Tiltott szerver',
  'agents.mcp_scope.dangerous_badge':        'Veszélyes',
  'agents.mcp_scope.save':                   'Hatáskör mentése',
  'agents.mcp_scope.save_ok':                'MCP hatáskör mentve.',
  'agents.mcp_scope.save_error':             'Hiba a hatáskör mentése során.',
  'agents.mcp_scope.unsaved':                'Nem mentett változtatások',
  'agents.mcp_scope.unknown_server_hint':    'Tool neve (pl. my_tool) -- egyéni szervernél',
  'agents.mcp_scope.add_custom_tool':        'Hozzáadás',
  'agents.mcp_scope.confirm_dangerous':      'Ez a beállítás veszélyes műveleteket (push, merge, delete) is engedélyez. Biztos?',
  'agents.mcp_scope.no_servers':             'Nincs konfigurált MCP szerver ehhez az ügynökhöz (.mcp.json).',
  'agents.mcp_scope.unmanaged_hint':         'Nincs egyéni hatáskör beállítva -- az ügynök a biztonsági profil jogait örökli.',
  ...
  'agents.settings.idle_flush_label': 'Tétlen-ürítés',
  'agents.settings.idle_flush_enabled': 'Bekapcsolva',
  'agents.settings.idle_flush_tokens_label': 'Küszöb (ezer token)',
  ...
  'memories.tab.artifacts':      '📦 Artifactok',
  'memories.artifacts.kind_all': 'Minden típus',
  'memories.artifacts.loading':  'Betöltés...',
  'memories.artifacts.load_error': 'Betöltési hiba.',
  'memories.artifacts.empty':    'Nincs artifact.',
  'memories.artifacts.col.agent':   'Ágens',
  'memories.artifacts.col.title':   'Cím',
  'memories.artifacts.col.kind':    'Típus',
  'memories.artifacts.col.date':    'Dátum',
  'memories.artifacts.col.actions': 'Műveletek',
  'memories.artifacts.btn.preview': 'Előnézet',
  'memories.artifacts.btn.open':    'Megnyitás',
  'memories.artifacts.btn.download':'Letöltés',
  'artifacts.btn.rename':          'Átnevezés',
  'artifacts.rename.placeholder':  'Új cím...',
  'artifacts.rename.success':      'Artifakt átnevezve.',
  'artifacts.rename.error':        'Átnevezés sikertelen.',
  ...
  // #953 settings-screen refactor: new section-tab ids (frontend-only
  // grouping, see web/modules/settings.js SECTION_ORDER) + subgroup headers.
  'settings.module.rendszer':          'Rendszer',
  'settings.module.csatornak':         'Csatornák & Biztonság',
  'settings.module.agensek':           'Ágensek & Heartbeat',
  'settings.module.memoria':           'Memória & Munkadokumentumok',
  'settings.module.fleet-monitor':     'Fleet monitor',
  'settings.module.adatmegorzs':       'Adatmegőrzés & Megfigyelhetőség',
  'settings.module.budgetek-csomagok': 'Budgetek & Claude csomagok',
  'settings.subgroup.agent_model': 'Ágens modell',
  'settings.subgroup.heartbeat':   'Heartbeat',
  'settings.subgroup.wip_limits':  'WIP limitek',
  'settings.subgroup.wip_colors':  'WIP badge színek',
  'settings.subgroup.archive':     'Auto-archiválás',
  'settings.subgroup.aging':       'Aging jelzők',
  'settings.subgroup.display':     'Megjelenítés',
  'settings.subgroup.ideabox':     'Ötletláda',
  'settings.subgroup.bb_signals':  'Jelzők (A és B jel)',
  'settings.subgroup.bb_stale':    'Stale-határok tier szerint',
  'settings.subgroup.audit_logs':  'Audit & naplók',
  'settings.subgroup.token_usage': 'Token használat',
  'settings.subgroup.otel':        'OpenTelemetry export',
  'settings.subgroup.backups':     'Mentések',
  'settings.costops.add_btn':    '+ Budget',
  'settings.costops.empty':      'Nincs konfigurált budget.',
  'settings.costops.col.name':   'Név',
  'settings.costops.col.scope':  'Hatókör',
  'settings.costops.col.amount': 'Felhasznált / limit',
  'settings.costops.col.status': 'Státusz',
  'settings.costops.modal.add_title':  'Új budget',
  'settings.costops.modal.edit_title': 'Budget szerkesztése',
  'settings.costops.field.id':          'ID',
  'settings.costops.field.id.hint':     'Kisbetű, szám, kötőjel/aláhúzás; szerkesztéskor nem módosítható',
  'settings.costops.field.name':        'Név',
  'settings.costops.field.scope':       'Hatókör',
  'settings.costops.field.scope_ref.agent':  'Ágens ID',
  'settings.costops.field.scope_ref.tenant': 'Tenant ID',
  'settings.costops.field.amount':      'Havi limit (token)',
  'settings.costops.field.warning_threshold': 'Warning küszöb',
  'settings.costops.field.hard_threshold':    'Hard küszöb',
  'settings.costops.field.block_on_hard':     'Blokkolás hard küszöbnél',
  'settings.costops.scope.global': 'Globális',
  'settings.costops.scope.agent':  'Ágens',
  'settings.costops.scope.tenant': 'Tenant',
  'settings.costops.toast.saved':   'Budget mentve',
  'settings.costops.toast.deleted': 'Budget törölve',
  'settings.costops.toast.error':   'Hiba történt',
  'settings.costops.confirm_delete': 'Biztosan törlöd a(z) "{id}" budgetet?',
  ...
  'settings.claude_plans.last_known': 'utolsó ismert: {pct}% (5h)',
  'settings.claude_plans.confirm_delete': 'Törlöd a(z) "{id}" plant a regisztryből?',
  'settings.claude_plans.form.id':          'Azonosító (id)',
  'settings.claude_plans.form.label':       'Címke',
  'settings.claude_plans.form.config_dir':  'CLAUDE_CONFIG_DIR',
  'settings.claude_plans.form.type':        'Típus',
  'settings.claude_plans.form.type_personal': 'Személyes',
  'settings.claude_plans.form.type_team':     'Csapat',
  'settings.claude_plans.form.channels_allowed': 'Channels (Telegram stb.) engedélyezve ezen a planen',
  ...
  'settings.desc.TOKEN_USAGE_RETENTION_DAYS':  'A nyers token-használati napló megőrzési ideje napokban. A napi sweep ennél régebbi sorokat aggregálja (napi/havi összesítők), majd törli.',
  'settings.desc.TOKEN_USAGE_DAILY_RETENTION_DAYS':  'A napi token-összesítők megőrzési ideje napokban. Az összesítők megőrzik az agent/model bontású napi tokenszámokat a számlázási és költségaudithoz.',
  'settings.desc.TOKEN_USAGE_MONTHLY_RETENTION_DAYS':  'A havi token-összesítők megőrzési ideje napokban. A havi adatok hosszú távú trendelemzéshez és éves audithoz szolgálnak.',
  ...
  'tokenUsage.costops_budgets_title': 'Havi tokenbudget-riasztás',
  'tokenUsage.costops_scope_global':  'globális',
  'tokenUsage.costops_scope_agent':   'agent: {name}',
  'tokenUsage.costops_scope_tenant':  'tenant: {name}',
  'tokenUsage.costops_blocked':       'blokkolva',
  ...
  'memories.stat.import':         'Import emlékek',
  'memories.stat.import_title':   'Külső forrásokból importált emlékek',

  'import.type.local':            'Helyi mappa',
  'import.type.gdrive':           'Google Drive',
  'import.type.sharepoint':       'SharePoint',
  'import.type.confluence':       'Confluence',
  'import.toggle.label':          'Aktív',
  'import.toggle.active':         'Aktív',
  'import.path.label':            'Útvonal / azonosító',
  'import.last_run':              'Utolsó futás',
  'import.col.type':              'Típus',
  'import.col.name':              'Megnevezés / Útvonal',
  'import.col.interval':          'Ciklus',
  'import.col.last_sync':         'Utolsó sync',
  'import.col.status':            'Státusz',
  'import.col.actions':           'Műveletek',
  'import.col.tenant':            'Tenant',
  'import.status.active':         'Aktív',
  'import.status.inactive':       'Inaktív',
  'import.btn.enable':            'Aktiválás',
  'import.btn.disable':           'Kikapcsolás',
  'import.btn.sync':              'Szinkronizálás most',
  'import.btn.syncing':           'Szinkronizálás...',
  'import.btn.log':               'Napló',
  'import.btn.wipe_source':       'Tartalom törlése',
  'import.btn.delete':            'Forrás törlése',
  'import.btn.add':               'Forrás hozzáadása',
  ...
  'import.log.added':             'Hozzáadva',
  'import.log.updated':           'Frissítve',
  'import.log.skipped':           'Kihagyva',
  'import.log.error':             'Hiba',
  'import.confirm.wipe_source':   'Törlöd ennek a forrásnak az összes importált emlékét?',
  'import.confirm.delete_source': 'Törlöd a forrást és az összes importált emlékét?',
  'import.confirm.wipe_all':      'Törlöd az összes importált emléket?',
  'import.toast.sync_queued':     'Szinkronizálás sorba helyezve.',
  'import.toast.source_added':    'Forrás hozzáadva.',
  'import.toast.deleted':         'Forrás törölve.',
  'import.toast.wiped':           'Importált emlékek törölve.',
  'import.toast.all_wiped':       'Összes importált emlék törölve.',
  'import.toast.error':           'Hiba történt.',
  'import.toast.path_required':   'Az útvonal megadása kötelező.',
  'import.form.type':             'Forrás típusa',
  'import.form.path':             'Útvonal / mappa-azonosító',
  'import.form.label':            'Megnevezés (opcionális)',
  'import.form.interval':         'Beolvasási ciklus',
  'import.form.tenant':           'Tenant',
  ...
  'import.form.base_url':         'Confluence-instance URL',
  ...
  'backups.stat.retention':            'Megtartott archívumok',
  'backups.stat.retention_value':      '{n} archívum',
  ...
  'backups.settings.keep_label':       'Megtartott mentések száma (BACKUP_KEEP)',
  'backups.settings.keep_hint':        'A legutóbbi N archívumot tartja meg; a fölöttieket a következő mentés törli.',
  ...
  'admin.b2b.tenant.add':            '+ Tenant',
  'admin.b2b.tenant.empty':          'Nincs tenant.',
  'admin.b2b.tenant.modal.title':    'Új tenant',
  'admin.b2b.tenant.id':             'Tenant ID',
  'admin.b2b.tenant.id.hint':        'Kisbetű, szám, kötőjel; 3-63 karakter',
  'admin.b2b.tenant.display_name':   'Megjelenített név',
  'admin.b2b.agent.matrix':          'Agent-hozzáférés',
  'admin.b2b.user.add':              '+ Felhasználó',
  'admin.b2b.user.filter.all':       'Mind a tenantok',
  'admin.b2b.user.modal.title':      'Új felhasználó',
  'admin.b2b.user.username':         'Felhasználónév',
  'admin.b2b.user.password':         'Jelszó (min. 12 kar.)',
  'admin.b2b.user.role':             'Szerepkör',
  ...
  'admin.b2b.permission_matrix.role.admin':     'Admin',
  ...
  'admin.b2b.permission_matrix.cat.approvals':  'Jóváhagyások',
  'admin.b2b.permission_matrix.cat.federation': 'Federáció',
  'admin.b2b.permission_matrix.cat.admin':      'Adminisztráció',
  'admin.b2b.perm.memories.read.label':    'Memória megtekintés',
  'admin.b2b.perm.memories.read.desc':     'Emlékek és visszakeresés olvasása',
  'admin.b2b.perm.memories.write.label':   'Memória szerkesztés',
  'admin.b2b.perm.memories.write.desc':    'Emlékek létrehozása, módosítása, törlése',
  'admin.b2b.perm.kanban.read.label':      'Feladatok megtekintés',
  'admin.b2b.perm.kanban.read.desc':       'Kanban kártyák és projektek olvasása',
  'admin.b2b.perm.kanban.write.label':     'Feladatok szerkesztés',
  'admin.b2b.perm.kanban.write.desc':      'Kártyák létrehozása, mozgatása, törlése',
  'admin.b2b.perm.agents.read.label':      'Ágens lista',
  'admin.b2b.perm.agents.read.desc':       'Ágensek és állapotuk megtekintése',
  'admin.b2b.perm.messages.write.label':   'Üzenet küldés',
  'admin.b2b.perm.messages.write.desc':    'Inter-agent üzenetek indítása',
  'admin.b2b.perm.blackboard.read.label':  'Fleet-tábla megtekintés',
  'admin.b2b.perm.blackboard.read.desc':   'Ágensek aktuális állapotsorának olvasása',
  'admin.b2b.perm.blackboard.write.label': 'Fleet-tábla frissítés',
  'admin.b2b.perm.blackboard.write.desc':  'Saját állapotsor írása a közös táblára',
  'admin.b2b.perm.approvals.read.label':   'Jóváhagyások megtekintés',
  'admin.b2b.perm.approvals.read.desc':    'Jóváhagyási kérelmek listázása és részletei',
  'admin.b2b.perm.approvals.write.label':  'Jóváhagyások kezelés',
  'admin.b2b.perm.approvals.write.desc':   'Kérelmek elfogadása vagy elutasítása',
  'admin.b2b.perm.federation.read.label':  'Federáció megtekintés',
  'admin.b2b.perm.federation.read.desc':   'Federált ágens kommunikáció olvasása',
  'admin.b2b.perm.federation.write.label': 'Federáció küldés',
  'admin.b2b.perm.federation.write.desc':  'Federált üzenetek és válaszok indítása',
  'admin.b2b.perm.admin.all.label':        'Teljes admin hozzáférés',
  'admin.b2b.perm.admin.all.desc':         'Felhasználók, tokenek, tenant-kezelés -- minden adminisztrációs művelet',

  'admin.b2b.screen_access.title':          'Felületek elérhetősége',
  'admin.b2b.screen_access.subtitle':       'Melyik szerepkör mely dashboard-felületet éri el',
  'admin.b2b.screen_access.shadow_note':    'Az RBAC jelenleg shadow módban fut; a fenti táblázat az éles enforce-állapotot mutatja. A (!) jelölésű felületeknél a nav-elrejtés még nem követi ezt -- ez az enforce-aktiválással együtt következő, külön munka.',
  'admin.b2b.screen_access.legend.full':    'teljes hozzáférés',
  'admin.b2b.screen_access.legend.ro':      'nav látható, olvasás OK, írás backend-tiltott',
  'admin.b2b.screen_access.legend.gap':     'nav látható, de enforce módban API 403 (frontend gating hiányzik)',
  'admin.b2b.screen_access.legend.none':    'nem érhető el (nav rejtett / page guard átirányít)',
  'admin.b2b.screen_access.screen.overview':      'Áttekintés',
  'admin.b2b.screen_access.screen.kanban':        'Kanban',
  'admin.b2b.screen_access.screen.approvals':     'Jóváhagyások',
  ...
  'admin.b2b.screen_access.screen.tokenUsage':    'Token monitor',
  'admin.b2b.screen_access.screen.status':        'Státusz',
  'admin.b2b.screen_access.screen.updates':       'Frissítések',
  ...
  'profile.subtitle':                     'A fiókod adatai és biztonsági beállításai',
  'profile.field.username':               'Felhasználónév',
  'profile.field.email':                  'E-mail',
  'profile.field.role':                   'Szerepkör',
  'profile.field.tenant':                 'Tenant',
  'profile.field.display_name':           'Megjelenített név',
  'profile.btn.edit':                     'Adatok szerkesztése',
  'profile.tenant.global':                'Globális admin',
  'profile.security.title':               'Biztonság',
  'profile.security.password.title':      'Jelszó módosítása',
  'profile.security.password.desc':       'Az új jelszó legalább 12 karakter hosszú legyen.',
  'profile.security.password.btn':        'Jelszó módosítása',
  'profile.security.sessions.title':      'Munkamenetek',
  'profile.security.sessions.desc':       '{n} aktív munkamenet. A kiléptetés minden eszközre érvényes, erre a böngészőre is.',
  'profile.security.sessions.btn':        'Összes kiléptetése',
  'profile.agents.title':                 'Elérhető ágensek',
  'profile.agents.placeholder':           'Itt jelennek meg a tenantod számára engedélyezett ágensek.',
  'profile.modal.edit.title':             'Adatok szerkesztése',
  'profile.modal.edit.desc':              'A felhasználónevét és szerepkörét az adminisztrátor módosíthatja.',
  'profile.modal.password.title':         'Jelszó módosítása',
  'profile.modal.password.desc':          'A mentés után a többi munkameneted bejelentkezve marad.',
  'profile.modal.password.current':       'Jelenlegi jelszó',
  'profile.modal.password.new':           'Új jelszó',
  'profile.modal.password.hint':          'Legalább 12 karakter.',
  'profile.modal.password.confirm':       'Új jelszó megerősítése',
  'profile.modal.password.mismatch':      'A két jelszó nem egyezik.',
  'profile.modal.password.too_short':     'A jelszó legalább 12 karakter legyen.',
  'profile.modal.sessions.title':         'Összes munkamenet kiléptetése',
  'profile.modal.sessions.desc':          'aktív munkamenetet léptetsz ki, ezt a böngészőt is beleértve. Utána újra be kell jelentkezned.',
  'profile.modal.sessions.confirm':       'Kiléptetés',
  'profile.saved':                        'Adatok mentve',
  'profile.password_saved':               'Jelszó frissítve',
  'profile.sessions_revoked':             'Minden munkamenet kiléptetve, átirányítás...',
  ...
  'admin.rbac.action.revoke':                   'Visszavonás',

  'admin.rbac.token.add':                       '+ Token',
  'admin.rbac.token.modal.title':               'Új token',
  'admin.rbac.token.expiry':                    'Lejárat (napokban, opcionális)',
  'admin.rbac.token.expiry_ph':                 'soha nem jár le',
  'admin.rbac.token.empty':                     'Nincs token.',
  'admin.rbac.token.expires_label':             'Lejár:',
  'admin.rbac.token.last_used_label':           'Utoljára használva:',
  'admin.rbac.token.revoked_badge':             'visszavonva',
  'admin.rbac.token.rotate':                    'Rotálás',
  'admin.rbac.token.name_required':             'Név szükséges',
  'admin.rbac.token.created':                   'Token létrehozva',
  'admin.rbac.token.rotate_confirm':            'Biztosan rotálod a(z) "{name}" tokent? A régi azonnal érvénytelen lesz.',
  'admin.rbac.token.rotated':                   'Token rotálva',
  'admin.rbac.token.revoke_confirm':            'Biztosan visszavonod a(z) "{name}" tokent?',
  'admin.rbac.token.revoked_toast':             'Token visszavonva',
  'admin.rbac.token.reveal.title':              'Token érték',
  'admin.rbac.token.reveal.desc':               'Ez az érték csak most jelenik meg -- mentsd el biztonságos helyre, mégegyszer nem lesz visszakérhető.',
  'admin.rbac.token.reveal.copy':                'Másolás',

  'admin.rbac.partner_sender.add':               '+ Partner-küldő',
  'admin.rbac.partner_sender.modal.title':       'Új partner-küldő',
  'admin.rbac.partner_sender.sender_id':         'Sender ID',
  'admin.rbac.partner_sender.sender_id_ph':      'pl. acme-support-bot',
  'admin.rbac.partner_sender.sender_id_hint':    'Betű/szám/kötőjel/aláhúzás, max 63 karakter; nem egyezhet fleet agent azonosítóval',
  'admin.rbac.partner_sender.empty':             'Nincs partner-küldő.',
  'admin.rbac.partner_sender.disabled_badge':    'letiltva',
  'admin.rbac.partner_sender.id_tenant_required':'Sender ID és tenant szükséges',
  'admin.rbac.partner_sender.created':           'Partner-küldő létrehozva',
  'admin.rbac.partner_sender.delete_confirm':    'Biztosan törlöd a(z) "{senderId}" partner-küldőt ({tenantId})?',
  'admin.rbac.partner_sender.deleted':           'Partner-küldő törölve',

  'admin.rbac.skill.select_placeholder':         '-- Válassz skillt --',
  'admin.rbac.skill.grant_add':                  '+ Hozzáférés megadása',
  'admin.rbac.skill.select_hint':                'Válassz egy skillt a hozzáférések kezeléséhez.',
  'admin.rbac.skill.list_load_error':            'Hiba a skill-lista betöltésekor:',
  'admin.rbac.skill.no_access':                  'Ez a skill egyetlen tenantnak sincs explicit megosztva.',
  'admin.rbac.skill.granted_label':              'Megosztva:',
  'admin.rbac.skill.tenant_required':            'Tenant szükséges',
  'admin.rbac.skill.granted_toast':              'Hozzáférés megadva',
  'admin.rbac.skill.revoke_confirm':             'Biztosan visszavonod a(z) "{tenantId}" tenant hozzáférését ehhez a skillhez?',
  'admin.rbac.skill.revoked_toast':              'Hozzáférés visszavonva',
  'admin.rbac.skill.grant.modal_title':          'Hozzáférés megadása',
  'admin.rbac.skill.grant.confirm':              'Megadás',
